(function(){
  const translations = {
    fr: {
      ...
      milestone_remain:'— 150.0M restants',
    ...
    es: {
      ...
      milestone_remain:'— 150.0M restantes',
    ...
    it: {
      ...
      milestone_remain:'— 150.0M mancanti',
